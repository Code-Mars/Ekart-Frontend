    ...
    return <div className=" flex items-center">
        <div className="w-full flex p-2 gap-2 items-center justify-between">
            ...
            <div className="flex h-full flex-col items-center justify-between gap-3">
                <span className="text-lg text-gray-700 font-semibold">${totalPrice}.00</span>
                <div className={`flex ${cart?'gap-4':'gap-1'} rounded-xl text-gray-600 text-sm font-semibold items-center px-3 py-1.5 bg-gray-100 w-fit`}>
                ...
                {cart && <TrashIcon onClick={() => dispatch(removeItem({ id }))} className="w-6 h-6 text-gray-600 hover:text-red-500 m-2 cursor-pointer" />}
            </div>
