...
const OrderItem=({name, price, ratings, desc, date, status})=>{
    ...
    <div className="w-full flex p-2 gap-2 items-center justify-between">
        ...
        <div className="flex h-full flex-col items-center justify-between gap-3">
            ...
            <div className="flex gap-4 rounded-xl text-sm font-semibold items-center px-3 py-1.5 bg-gray-100 w-fit"> Quantity: 1 </div>
